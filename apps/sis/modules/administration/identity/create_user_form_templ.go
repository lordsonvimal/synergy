...
func RenderCreateUserWithRelationsForm(
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "</select> <button type=\"button\" class=\"px-2\" data-on:click=\"$rows.splice(i, 1)\">✕</button></div></template><button type=\"button\" class=\"text-sm text-blue-600\" data-on:click=\"$rows.push({})\">+ Add role</button></div></section><!-- ================= Parents / Guardians ================= --><section class=\"space-y-4\"><h3 class=\"font-semibold text-lg\">Parents / Guardians</h3><div data-store='{ \"relations\": [ {} ] }' class=\"space-y-3\"><template data-for=\"(r, i) in $relations\"><div class=\"grid grid-cols-3 gap-2\"><select name=\"relations[][relationship_type]\" class=\"rounded border px-2 py-1\" required><option value=\"\">Relation</option> <option value=\"father\">Father</option> <option value=\"mother\">Mother</option> <option value=\"guardian\">Guardian</option></select> <input type=\"email\" name=\"relations[][email]\" placeholder=\"Email\" class=\"rounded border px-2 py-1\"> <input type=\"text\" name=\"relations[][name]\" placeholder=\"Name\" class=\"rounded border px-2 py-1\"></div></template><button type=\"button\" class=\"text-sm text-blue-600\" data-on:click=\"$relations.push({})\">+ Add parent / guardian</button></div></section><!-- ================= Submit ================= --><div class=\"flex justify-end gap-2 pt-4\"><button type=\"submit\" class=\"rounded bg-blue-600 px-5 py-2 text-white\">Create User</button></div></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
